...
const baseGlobal: object = { nextId: 0 };

export const Global = {
  encode(message: Global, writer: Writer = Writer.create()): Writer {
    if (message.nextId !== 0) {
  ...
  decode(input: Reader | Uint8Array, length?: number): Global {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseGlobal } as Global;
  ...
  toJSON(message: Global): unknown {
    const obj: any = {};
    message.nextId !== undefined && (obj.nextId = message.nextId);
    return obj;
  },

  fromPartial(object: DeepPartial<Global>): Global {
    const message = { ...baseGlobal } as Global;
    if (object.nextId !== undefined && object.nextId !== null) {
