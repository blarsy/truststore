...
export interface MsgUpdateAttestation {
  creator: string;
  index: string;
  identifier: string;
  identifierType: string;
...
export interface MsgUpdateAttestationResponse {}
...
const baseMsgUpdateAttestation: object = {
  creator: "",
  index: "",
  identifier: "",
  identifierType: "",
...
export const MsgUpdateAttestation = {
  encode(
    ...
    if (message.identifierType !== "") {
      writer.uint32(34).string(message.identifierType);
    }
    if (message.rating !== 0) {
      writer.uint32(40).uint64(message.rating);
    }
    return writer;
  },

  decode(input: Reader | Uint8Array, length?: number): MsgUpdateAttestation {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseMsgUpdateAttestation } as MsgUpdateAttestation;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): MsgUpdateAttestation {
    const message = { ...baseMsgUpdateAttestation } as MsgUpdateAttestation;
    if (object.creator !== undefined && object.creator !== null) {
      message.creator = String(object.creator);
    } else {
  ...
  toJSON(message: MsgUpdateAttestation): unknown {
    const obj: any = {};
    message.creator !== undefined && (obj.creator = message.creator);
  ...
  fromPartial(object: DeepPartial<MsgUpdateAttestation>): MsgUpdateAttestation {
    const message = { ...baseMsgUpdateAttestation } as MsgUpdateAttestation;
    if (object.creator !== undefined && object.creator !== null) {
      message.creator = object.creator;
    } else {
...
const baseMsgUpdateAttestationResponse: object = {};

export const MsgUpdateAttestationResponse = {
  encode(
    _: MsgUpdateAttestationResponse,
    writer: Writer = Writer.create()
  ): Writer {
    return writer;
  },
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number
  ): MsgUpdateAttestationResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgUpdateAttestationResponse,
    } as MsgUpdateAttestationResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        default:
  ...
  fromJSON(_: any): MsgUpdateAttestationResponse {
    const message = {
      ...baseMsgUpdateAttestationResponse,
    } as MsgUpdateAttestationResponse;
    return message;
  ...
  toJSON(_: MsgUpdateAttestationResponse): unknown {
    const obj: any = {};
    return obj;
  },

  fromPartial(
    _: DeepPartial<MsgUpdateAttestationResponse>
  ): MsgUpdateAttestationResponse {
    const message = {
      ...baseMsgUpdateAttestationResponse,
    } as MsgUpdateAttestationResponse;
...
export interface Msg {
  ...
  UpdateAttestation(
    request: MsgUpdateAttestation
  ): Promise<MsgUpdateAttestationResponse>;
}
...
export class MsgClientImpl implements Msg {
  ...
  UpdateAttestation(
    ...
    const data = MsgUpdateAttestation.encode(request).finish();
    const promise = this.rpc.request(
      "blarsy.truststore.truststore.Msg",
      "UpdateAttestation",
      data
    ...
    return promise.then((data) =>
      MsgUpdateAttestationResponse.decode(new Reader(data))
    );
  }
}
